...
#include "AActionActor.h"
#include "Engine/GameEngine.h"

// Sets default values
AAActionActor::AAActionActor()
{
...
// Called every frame
void AAActionActor::Tick(float DeltaTime)
{
...
void AAActionActor::SetRotate(bool doRotate) 
{
	doRotationFlag = doRotate; //set rotateflag based on input
}
//----------------

int AAActionActor::NextIndex() 
{
...
bool AAActionActor::NextRotation()
{
...
bool AAActionActor::ResetRotation()
{
